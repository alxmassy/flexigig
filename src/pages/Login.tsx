            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-primary-400 transition-colors duration-200 focus:outline-none bg-transparent"
                >
                  {showPassword ? (
